...
vignette: >
  %\VignetteIndexEntry{grouped_operations_with_margins}
...
<!-- Here, using `jprep.datasets::tabset_quarto()` together, -->
<!-- create figures for each group and -->
<!-- show them using the nested tabset panels. -->
<!-- `tabset_quarto()` works with quarto documents (.qmd files). -->
<!-- You need to specify `#| results: asis` in the chunk option. -->

<!-- :::{.callout-tip} -->
<!-- For details on `tabset_quarto()`,  -->
<!-- see [here](http://10.13.123.231:3838/team_package/demo/demo_tabset_quarto.html). -->
<!-- ::: -->
...
<!--         geom_col() + -->
<!--         labs( -->
<!--           title = str_glue("{cat} | {subcat} | {g1} | {g2}") -->
<!--         ) -->
<!--     ) -->
<!--   ) |>  -->
<!--   tabset_quarto(c(cat, subcat, g1, g2), fig) -->
<!-- ``` -->
